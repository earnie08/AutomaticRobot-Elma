...
namespace robot{
    class Robot_Core : public Process{
        ...
        //! \param batterySize The initial position of robot
        //! \param consumeRate The initial position of robot
        Robot_Core(string robotName, MapInfo *mpinfo, vector<int> robotPosition, int batterySize, int consumeRate);
